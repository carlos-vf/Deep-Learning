...
\begin{frame}{Conclusions}
    ...
    \begin{figure}
        \centering
        \movie[width=0.8\textwidth, showcontrols]{
            \includegraphics[width=0.8\textwidth]{images/video_screenshot.png} % A screenshot from the video
        }{videos/7463_standard_classified.mp4}
    \end{figure}
...
\begin{frame}{Future Work}
    ...
    \vspace{1.5em} % Add some vertical space from the title
    
    \begin{columns}[T,totalwidth=\textwidth] % Aligns columns and uses full width
